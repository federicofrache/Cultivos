...
function Breadcrumb({ nav, setNav, campania, cultivo, campo }) {
  if (["campanias", "campos", "insumos", "resumen_general", "papelera", "usuarios", "ordenes"].includes(nav.view)) return null;
  return (
  ...
  const confirmarLitros = async (orden, idx, valorCrudo) => {
    ...
    try {
      ...
      const nuevoGasto = await gastosApiGlobal.add({
        ...
        categoriaGasto: "Insumo", socio: orden.socio || "", modoMonto: null, valorPorHectarea: null, ordenTrabajoId: orden.id,
      });
